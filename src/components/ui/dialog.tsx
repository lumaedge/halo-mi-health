...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close aria-label="Close" className="absolute right-4 top-4 rounded-xl p-1 text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors">
